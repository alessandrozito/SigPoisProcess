...
saveRDS(object = out, file = "~/SigPoisProcess/output/ICGC/Breast_MAP.rds.gzip", compress = "gzip")
...
saveRDS(object = out, file = "~/SigPoisProcess/output/ICGC/Breast_MAP_sig.rds.gzip", compress = "gzip")
...
out <- SigPoisProcess(gr_Mutations = TumorData$gr_tumor,
                      ...
                      method = "mle",
                      controls = SigPoisProcess.controls(maxiter = maxiter, merge_move = FALSE))
saveRDS(object = out, file = "~/SigPoisProcess/output/ICGC/Breast_MLE.rds.gzip", compress = "gzip")


# Breast cancer

outMAP <- readRDS("~/SigPoisProcess/output/ICGC/Breast_MAP.rds.gzip")
plot(outMAP)


outMLE <- readRDS("~/SigPoisProcess/output/ICGC/Breast_MLE.rds.gzip")
plot(outMLE)
