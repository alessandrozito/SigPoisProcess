...
saveRDS(object = out, file = "~/SigPoisProcess/output/ICGC/Skin-Melanoma_MAP.rds.gzip", compress = "gzip")
...
saveRDS(object = out, file = "~/SigPoisProcess/output/ICGC/Skin-Melanoma_MAP_sig.rds.gzip", compress = "gzip")
...
out <- SigPoisProcess(gr_Mutations = TumorData$gr_tumor,
                      ...
                      method = "mle",
                      controls = SigPoisProcess.controls(maxiter = maxiter, merge_move = FALSE))
saveRDS(object = out, file = "~/SigPoisProcess/output/ICGC/Skin-Melanoma_MLE.rds.gzip", compress = "gzip")



outMAP <- readRDS("~/SigPoisProcess/output/ICGC/Liver-HCC_MAP.rds.gzip")
plot(outMAP)
